...
export default function SettingsPanel({ settings, onChange, onReset }) {
  ...
  return (
    <div className="rounded-2xl bg-white dark:bg-black border border-black/10 dark:border-white/10 shadow-sm overflow-auto h-full flex flex-col">
      ...
      <div className="p-3 sm:p-4 space-y-4 text-sm">
        ...
        <div>
          ...
          <select
            className="w-full rounded-lg border border-black/10 dark:border-white/20 bg-white dark:bg-black p-2 shadow-sm focus:outline-none focus-visible:ring-2 focus-visible:ring-black/20 dark:focus-visible:ring-white/20"
        ...
        <div>
          ...
          <input
            ...
            className="w-24 rounded-lg border border-black/10 dark:border-white/20 bg-white dark:bg-black p-2 shadow-sm focus:outline-none focus-visible:ring-2 focus-visible:ring-black/20 dark:focus-visible:ring-white/20"
          />
        </div>
        ...
        <div className="pt-2">
          <button
            onClick={onReset}
            className="px-3 py-1.5 rounded-lg text-sm bg-black text-white dark:bg-white dark:text-black shadow-sm"
